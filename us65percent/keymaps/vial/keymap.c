...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
  KC_ESCAPE, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, S(KC_6), KC_BACKSLASH,
  KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LEFT_BRACKET, KC_RIGHT_BRACKET, KC_DELETE,
  ...
  KC_LEFT_GUI, KC_LEFT_CTRL, KC_LEFT_ALT, KC_NO, KC_SPACE, KC_NO, KC_NO, KC_NO, KC_NO, KC_RIGHT_ALT, KC_NO, KC_RIGHT_GUI
),
    [1] = LAYOUT_65_ansi(
