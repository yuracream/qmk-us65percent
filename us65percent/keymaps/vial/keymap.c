...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
      ...
      KC_LEFT_GUI,KC_LEFT_ALT,KC_LEFT_GUI,KC_LANGUAGE_2,KC_SPACE,KC_ENTER,KC_TRANSPARENT,KC_LANGUAGE_1,KC_TRANSPARENT,KC_RIGHT_ALT,KC_APPLICATION,KC_RIGHT_GUI
    ),
    [1] = LAYOUT_65_ansi(
